...
In this chapter, we're going to learn what happens when you do something like `myOjb * 2`, and how to implement it. However, this may not be the best way to write your code.
